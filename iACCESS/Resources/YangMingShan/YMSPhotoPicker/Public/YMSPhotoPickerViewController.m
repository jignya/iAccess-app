...
- (void)viewDidLoad
{
    ...
    [navigationItem.leftBarButtonItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys: [UIColor blackColor],  NSForegroundColorAttributeName,nil] forState:UIControlStateNormal];
...
{
//    if (indexPath.row == 0) {   // Camera Cell  jignya
...
//    }
    ...
    if ([self shouldOrderSelection] && [self.selectedPhotos containsObject:asset]) {
        ...
        cell.selectionOrder = selectionIndex;
    }
